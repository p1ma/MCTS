...
La première variante \ref{modifDiscret} consiste à réutiliser le MCTS discret, la deuxième variante \ref{pw} permet de travailler directement avec des entités continues cependant la gestion d'un bruit parasite n'est pas effectuée. Et la dernière variante \ref{dpw} gère les entités continues ainsi que la gestion des bruits parasites.
	...
	\subsection{Première approche}
		\subsubsection{Modification du MCTS discret} \label{modifDiscret}
