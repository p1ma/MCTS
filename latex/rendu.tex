...
\subsection{Expérimentations} \label{exp}
	Dans cette partie, nous allons  appliquer chacun des algorithmes précèdemment décrit au problème \ref{probleme}.
	De plus, nous ferons varier différents paramètres tels que la constante d'exploration $C$, $\alpha$ et le temps d'éxécution, afin observer les différentes conséquences sur les résultats obtenus.
