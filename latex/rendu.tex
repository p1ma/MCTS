...
\subsection{Abstrait}
	...
	\subsubsection{Double progressive widening} \label{dpw}
		...
		\subsubsubsection{Pseudo-code} \label{dpw:code}
			...
			Et voici, l'algorithme MCTS avec la stratégie double progressive widening, algorithme très proche de l'algorithme MCTS avec progressive widening \ref{alg:mctspw}
